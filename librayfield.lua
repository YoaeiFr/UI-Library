...
local RayfieldLibrary = {
	...
	Theme = {
		...
		Light = {
			...
			TextColor = Color3.fromRGB(69,69,207s), -- i need to make all text 240, 240, 240 and base gray on transparency not color to do this
			...
			TabBackgroundSelected = Color3.fromRGB(69,69,207),
			TabTextColor = Color3.fromRGB(240, 240, 240),
			SelectedTabTextColor = Color3.fromRGB(50, 50, 50),
